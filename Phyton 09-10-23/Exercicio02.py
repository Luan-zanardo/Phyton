class JogoDaVela:
    ...
    def exibir_tabuleiro(self):
        print("┌───┬───┬───┐ ┌───┬───┬───┐")
        print(f"│ {self.tabuleiro['7']} │ {self.tabuleiro['8']} │ {self.tabuleiro['9']} │ │ 7   8   9 │")
        print("├───┼───┼───┤ ├───┼───┼───┤")
        print(f"│ {self.tabuleiro['4']} │ {self.tabuleiro['5']} │ {self.tabuleiro['6']} │ │ 4   5   6 |")
        print("├───┼───┼───┤ ├───┼───┼───┤")
        print(f"│ {self.tabuleiro['1']} │ {self.tabuleiro['2']} │ {self.tabuleiro['3']} │ │ 1   2   3 │")
        print("└───┴───┴───┘ └───┴───┴───┘")
